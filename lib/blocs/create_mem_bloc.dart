...
class CreateMemeBloc {
  ...
  void addNewText() {
    /**
     * каскадный оператор который возвращает значене полученной в void  методе
     */
    // memeTextsSubject.add(memeTextsSubject.value..add(MemeText.create()));
    /**
     * Спред оператор функционал такойже
     */
  ...
  void selectedMemeText(String id) {
  ...
  Stream<List<MemeTextWithSelection>> observeMemeTextsWithSelected() {
